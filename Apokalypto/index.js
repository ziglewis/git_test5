...
let characters = ["🤡", "🤩","🤫","🤑", "😁", "😍","👳", "🎅","👸🏾", "👮", "👴", "😋", "🤯","🕵️‍♂️", "😝", "🤨", "😘", "🤠","😲", "😎", "😇", "🤴", "🙆", "👨‍👩‍👧‍👧", "🧙‍♂️", "🧛‍♀️", "🙋‍♂️", "🤹", "🕴", "🧘", "💃", "🕺", "🧝‍♀️", "👩‍🚀", "🧔", "🧕", "👩‍🌾", "👩‍💻", "👨‍⚖️", "👩‍🔧", "👩‍🔬", "💂‍♀️"]
  ...
  // here i declared all the values I want the game to return
    ...
    function random(){
       ...
       // Here I want the scores to display values obtained as the game progresses
        ...
        message = msgOneWin[Math.floor(Math.random() * msgOneWin.length)] 
        turnsLeft = "Six balls to go"}
         else if (w === 1 && score1 < score2) {
         message = msgOneLoose[Math.floor(Math.random() * msgOneLoose.length)]
         turnsLeft = "Six balls to go" } 
         else if (w === 1 && score1 === score2) {
         message = tie[Math.floor(Math.random() * tie.length)] 
         turnsLeft = "Six balls to go" } 
        ...
        message = msgTwoWin[Math.floor(Math.random() * msgTwoWin.length)] 
        turnsLeft = "Five balls to go"}
         else if (w === 2 && score1 < score2) {
         message = msgTwoLoose[Math.floor(Math.random() * msgTwoLoose.length)]
         turnsLeft = "Five balls to go" } 
         else if (w === 2 && score1 === score2) {
         message = tie[Math.floor(Math.random() * tie.length)] 
         turnsLeft = "Five balls to go" } 
        ...
        message = msgThreeWin[Math.floor(Math.random() * msgThreeWin.length)] 
        turnsLeft = "Four balls to go"}
         else if (w === 3 && score1< score2) {
         message = msgThreeLoose[Math.floor(Math.random() * msgThreeLoose.length)]
         turnsLeft = "Four balls to go" } 
         else if (w === 3 && score1 === score2) {
         message = tie[Math.floor(Math.random() * tie.length)] 
         turnsLeft = "Four balls to go" } 
      ...
      // if statement for the Fourth round of the game
        ...
        message = msgFourWin[Math.floor(Math.random() * msgFourWin.length)] 
        turnsLeft = "Three balls to go"}
         else if (w === 4 && score1 < score2 && difference <= 270) {
         message = msgFourLoose[Math.floor(Math.random() * msgFourLoose.length)]
         turnsLeft = "Three balls to go" } 
        ...
        message = msgFiveWin[Math.floor(Math.random() * msgFiveWin.length)] 
        turnsLeft = "Two balls to go"}
         else if (w === 5 && score1 < score2 && difference <= 180) {
         message = msgFiveLoose[Math.floor(Math.random() * msgFiveLoose.length)]
         turnsLeft = "Two balls to go"} 
       ...
       //statement for games far beyond reach in round five
        ...
        message = msgSixWin[Math.floor(Math.random() * msgSixWin.length)] 
        turnsLeft = "One last ball to go"}
         else if (w === 6 && score1 < score2 && difference <= 180) {
         message = msgSixLoose[Math.floor(Math.random() * msgSixLoose.length)]
         turnsLeft = "One last ball to go"} 
  ...
  //FIRST COMPLETED ON 13 TH JANUARY 2023: TOOK ME 1 WEEK (6 DAYS).
